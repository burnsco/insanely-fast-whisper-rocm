...
import insanely_fast_whisper_rocm.utils.constant as constants_module
...
class TestCentralizedConfiguration:
    ...
    def test_default_values_without_env_vars(self) -> None:
        ...
        with patch(
            ...
            assert constants_module.DEFAULT_MODEL == "distil-whisper/distil-large-v3.5"
...
class TestModuleCentralizedConfigurationUsage:
    ...
    def test_app_module_uses_centralized_config(self) -> None:
        ...
        from insanely_fast_whisper_rocm.utils.constant import DEFAULT_MODEL
    ...
    def test_filename_generator_uses_centralized_config(self) -> None:
        ...
        from insanely_fast_whisper_rocm.utils.constant import FILENAME_TIMEZONE
...
class TestDotEnvFileSupport:
    ...
    def test_dotenv_file_loading(self) -> None:
        ...
        try:
            ...
            with (
                ...
                patch(
                    "insanely_fast_whisper_rocm.utils.env_loader.load_dotenv"
                ) as mock_load,
            ):
                reload(constants_module)
    ...
    def test_config_dir_creation(self) -> None:
        ...
        with patch(
            "insanely_fast_whisper_rocm.utils.constant.CONFIG_DIR"
        ) as mock_config_dir:
            mock_path = MagicMock()
